...
- :mod:`Filtering_Pipeline.stage_2a.filters.identity_filters` — model self-identification
- :mod:`Filtering_Pipeline.stage_2a.filters.content_filters`  — knowledge-cutoff phrasing
- :mod:`Filtering_Pipeline.stage_2a.filters.domain_filters`   — optional toxicity/redaction flags
