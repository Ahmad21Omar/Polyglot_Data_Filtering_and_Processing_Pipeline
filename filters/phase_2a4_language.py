...
- :mod:`Filtering_Pipeline.filters.language_filters`        — Chinese-character ratio
- :mod:`Filtering_Pipeline.filters.english_fasttext_filter` — English-only FastText LID
- :mod:`Filtering_Pipeline.filters.language_detector`       — generic 218-language detector
...
``from Filtering_Pipeline.filters import phase_2a4_language as lang`` import.
