...
used by :mod:`Filtering_Pipeline.filter_and_format.pipeline`. Per-dataset
...
_REPO_ROOT = Path(__file__).resolve().parents[2]  # Master_Thesis/
...
class FilterConfig:
    ...
    fasttext_threshold, fasttext_min_chars, fasttext_keep_if_too_short
        Forwarded to :class:`Filtering_Pipeline.filters.phase_2a4_language.EnglishLidConfig`.
    fasttext_model_path
