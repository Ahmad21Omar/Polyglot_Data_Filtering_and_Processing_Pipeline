...
from Filtering_Pipeline.stage_2a.filter_and_format.adapters.soofi_think_sft_10b_multilingual import (
    SoofiThinkSft10bMultilingualAdapter,
)
from Filtering_Pipeline.stage_2a.filter_and_format.config import FilterConfig
from Filtering_Pipeline.stage_2a.filter_and_format.runner import run as _run_adapter
