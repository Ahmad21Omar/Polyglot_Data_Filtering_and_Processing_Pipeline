...
- :mod:`Filtering_Pipeline.stage_2a.filters.phase_2a1_structural`     — messages / assistant presence, prompt length
- :mod:`Filtering_Pipeline.stage_2a.filters.phase_2a2_think_reasoning` — think-tag presence, min chars, truncation
- :mod:`Filtering_Pipeline.stage_2a.filters.phase_2a3_prompt_question` — URL / image / length heuristics
- :mod:`Filtering_Pipeline.stage_2a.filters.phase_2a4_language`        — FastText LID, Chinese ratio
- :mod:`Filtering_Pipeline.stage_2a.filters.phase_2a5_identity_safety` — identity self-id, cutoff mention, safety flags
- :mod:`Filtering_Pipeline.stage_2a.filters.phase_2a6_repetition`      — sentence / phrase repetition

Cross-cutting utilities live under :mod:`Filtering_Pipeline.stage_2a.filters._utils`
